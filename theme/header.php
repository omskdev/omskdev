	...
	<header id="masthead">
		<div class="container mx-auto px-4">
			...
			if ( $omskdev_description || is_customize_preview() ) :
				?>
				<p><?php echo $omskdev_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
			<?php endif; ?>
		</div>

		<nav id="site-navigation">
			<button aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Primary Menu', 'omskdev' ); ?></button>
			<?php
			wp_nav_menu(
				array(
